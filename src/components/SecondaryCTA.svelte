...
<div class={orientationClass}>
    ...
    <div class={iconAlignment}>
        <!-- facebook -->
        <a href="https://www.facebook.com/aeulogy" >
        ...
        <!-- twitter -->
        <div class="h-[36px] w-[36px]">
            <a href="https://twitter.com/WriteAeulogy" >
                <svg style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1" viewBox="0 0 512 512" width="100%" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <!-- insta -->
        <div class="h-[36px] w-[36px]">
            <a href="https://www.instagram.com/memoriesbyaeulogy/">
